...
public sealed class NotificationsModuleTests
{
    ...
    public void NotificationsModule_DoesNotReferenceUsersInternalProject()
    {
        ...
        Assert.False(
            referencedNames.Contains("Hemma.Modules.Users"),
    ...
    public void IEmailSender_IsNotUsedOutsideNotificationsAndSharedInfrastructure()
    {
        ...
        foreach (var assembly in otherModuleAssemblies)
        {
            var result = Types.InAssembly(assembly)
                .ShouldNot()
                .HaveDependencyOn("Hemma.Shared.Infrastructure.Notifications")
                .GetResult();
        ...
        Assert.True(violations.Count == 0,
            "FAIL: IEmailSender / ISmsSender must only be used inside Hemma.Modules.Notifications " +
            "and Hemma.Shared.Infrastructure. " +
