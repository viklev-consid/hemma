...
1. Echo the plan: module name, projects to be created (`Hemma.Modules.<Name>` and `Hemma.Modules.<Name>.Contracts`), solution file additions.
2. Ask the user to confirm before running anything.
3. On confirmation, run the module template: `dotnet new hemma-module --name <Name> --output src/Modules/<Name>`
