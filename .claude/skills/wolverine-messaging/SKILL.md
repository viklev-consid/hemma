...
description: Repo-specific guidance for using Wolverine in Hemma. Covers IMessageBus dispatch, handler registration, outbox semantics, subscriber design, scheduled jobs, and testing with TrackActivity.
---
