...
{
    internal const string SourceName = "Hemma.Modules.ModuleName";
    internal const string MeterName = "Hemma.Modules.ModuleName";
    ...
    internal static readonly Counter<long> CommandsHandled =
        meter.CreateCounter<long>(
            "hemma.modulenamelower.commands.handled",
    ...
    internal static readonly Counter<long> EventsProcessed =
        meter.CreateCounter<long>(
            "hemma.modulenamelower.events.processed",
