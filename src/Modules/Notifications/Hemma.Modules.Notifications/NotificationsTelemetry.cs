...
{
    internal const string SourceName = "Hemma.Modules.Notifications";
    internal const string MeterName = "Hemma.Modules.Notifications";
    ...
    internal static readonly Counter<long> EventsProcessed =
        meter.CreateCounter<long>(
            "hemma.notifications.events.processed",
    ...
    internal static readonly Counter<long> SendGuardStaleRecoveries =
        meter.CreateCounter<long>(
            "hemma.notifications.send_guard.stale_recoveries",
    ...
    internal static readonly Counter<long> SendGuardFailedRecoveries =
        meter.CreateCounter<long>(
            "hemma.notifications.send_guard.failed_recoveries",
