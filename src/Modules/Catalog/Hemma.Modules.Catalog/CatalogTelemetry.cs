...
{
    internal const string SourceName = "Hemma.Modules.Catalog";
    internal const string MeterName = "Hemma.Modules.Catalog";
    ...
    internal static readonly Counter<long> CommandsHandled =
        meter.CreateCounter<long>(
            "hemma.catalog.commands.handled",
    ...
    internal static readonly Counter<long> EventsProcessed =
        meter.CreateCounter<long>(
            "hemma.catalog.events.processed",
