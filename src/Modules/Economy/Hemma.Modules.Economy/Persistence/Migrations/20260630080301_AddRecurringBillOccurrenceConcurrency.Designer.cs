...
namespace Hemma.Modules.Economy.Persistence.Migrations
{
    ...
    [Migration("20260630080301_AddRecurringBillOccurrenceConcurrency")]
    partial class AddRecurringBillOccurrenceConcurrency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hemma.Modules.Economy.Domain.CategorizationRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("HouseholdId")
                        .HasDatabaseName("ix_categorization_rules_household_id");

                    b.HasIndex("TargetCategoryId")
                        .HasDatabaseName("ix_categorization_rules_target_category_id");

                    b.HasIndex("HouseholdId", "Match", "Pattern")
                        .IsUnique()
                        .HasDatabaseName("ix_categorization_rules_household_id_match_pattern");

                    b.ToTable("categorization_rules", "economy");
                });
            ...
            modelBuilder.Entity("Hemma.Modules.Economy.Domain.EconomyNotificationPreferences", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<bool>("BillAlertsEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("bill_alerts_enabled");
                    ...
                    b.Property<bool>("TrialAlertsEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("trial_alerts_enabled");
                    ...
                    b.HasIndex("HouseholdId")
                        .IsUnique()
                        .HasDatabaseName("ix_notification_preferences_household_id");

                    b.ToTable("notification_preferences", "economy");
                });
            ...
            modelBuilder.Entity("Hemma.Modules.Economy.Domain.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("HouseholdId", "Name")
                        .HasDatabaseName("ix_subscriptions_household_id_name");

                    b.HasIndex("HouseholdId", "TrialEndsOn")
                        .HasDatabaseName("ix_subscriptions_household_id_trial_ends_on");

                    b.ToTable("subscriptions", "economy");
                });
            ...
            modelBuilder.Entity("Hemma.Modules.Economy.Domain.Transaction", b =>
                {
                    ...
                    b.HasIndex("SubscriptionId")
                        .HasDatabaseName("ix_transactions_subscription_id");

                    b.HasIndex("TransferId")
                        .HasDatabaseName("ix_transactions_transfer_id");

                    b.HasIndex("AccountId", "ImportFingerprint")
                        .IsUnique()
                        .HasDatabaseName("ix_transactions_account_id_import_fingerprint")
            ...
            modelBuilder.Entity("Hemma.Modules.Economy.Domain.CategorizationRule", b =>
                {
                    b.HasOne("Hemma.Modules.Economy.Domain.Category", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_categorization_rules_categories_target_category_id");
                });
            ...
            modelBuilder.Entity("Hemma.Modules.Economy.Domain.Subscription", b =>
                {
                    ...
                    b.OwnsOne("Hemma.Shared.Kernel.Domain.Money", "ExpectedAmount", b1 =>
                        {
                            ...
                            b1.ToTable("subscriptions", "economy");
                    ...
                    b.OwnsOne("Hemma.Modules.Economy.Domain.SubscriptionCadence", "Cadence", b1 =>
                        {
                            b1.Property<Guid>("SubscriptionId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");

                            b1.Property<int>("ChargeDay")
                                .HasColumnType("integer")
