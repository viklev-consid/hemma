...
using Hemma.Modules.Economy.Features.DeleteTransaction;
...
using Hemma.Modules.Economy.Features.GetProjectSpendSummary;
...
public static class EconomyModule
{
    ...
    public static WolverineOptions AddEconomyHandlers(this WolverineOptions opts)
    {
        ...
        opts.Discovery.IncludeType<UpdateTransactionHandler>();
        opts.Discovery.IncludeType<DeleteTransactionHandler>();
        opts.Discovery.IncludeType<AttachReceiptHandler>();
        opts.Discovery.IncludeType<ListTransactionsHandler>();
        opts.Discovery.IncludeType<AssignTransactionToProjectHandler>();
        opts.Discovery.IncludeType<ListTransactionsForProjectHandler>();
        opts.Discovery.IncludeType<GetProjectSpendSummaryHandler>();
        ...
        opts.Discovery.IncludeType<OnProjectDeletedHandler>();
    ...
    public static IEndpointRouteBuilder MapEconomyEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        UpdateTransactionEndpoint.Map(app);
        DeleteTransactionEndpoint.Map(app);
        AttachReceiptEndpoint.Map(app);
        ListTransactionsEndpoint.Map(app);
        AssignTransactionToProjectEndpoint.Map(app);
        ListTransactionsForProjectEndpoint.Map(app);
