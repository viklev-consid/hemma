...
namespace Hemma.Modules.Users.Persistence.Migrations
{
    ...
    [Migration("20260521102348_NormalizeTermsAcceptanceVersion")]
    partial class NormalizeTermsAcceptanceVersion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.Consent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.LegalDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<bool>("IsRequiredForOnboarding")
                        .HasColumnType("boolean")
                        .HasColumnName("is_required_for_onboarding");
                    ...
                    b.HasIndex("DocumentType", "Version")
                        .IsUnique()
                        .HasDatabaseName("ix_legal_documents_document_type_version");
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.PendingEmailChange", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.PendingTwoFactorChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.RecoveryCode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.SingleUseToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.TermsAcceptance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("LegalDocumentId")
                        .HasDatabaseName("ix_terms_acceptances_legal_document_id");

                    b.HasIndex("UserId", "DocumentType", "Version")
                        .IsUnique()
                        .HasDatabaseName("ix_terms_acceptances_user_id_document_type_version");

                    b.ToTable("terms_acceptances", "users");
                });

            modelBuilder.Entity("Hemma.Modules.Users.Domain.TwoFactorCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.UserInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.PendingEmailChange", b =>
                {
                    b.HasOne("Hemma.Modules.Users.Domain.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Hemma.Modules.Users.Domain.TermsAcceptance", b =>
                {
                    b.HasOne("Hemma.Modules.Users.Domain.LegalDocument", null)
                        .WithMany()
                        .HasForeignKey("LegalDocumentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_terms_acceptances_legal_documents_legal_document_id");
