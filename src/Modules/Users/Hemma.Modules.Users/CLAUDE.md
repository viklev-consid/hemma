...
- **PendingTwoFactorChallenge** - short-lived login challenge issued after first-factor success when local 2FA is enabled.
...
Events are published from `Hemma.Modules.Users.Contracts/Events/`. Consumers live in other modules; Users does not know who subscribes.
