...
namespace Hemma.Modules.Organizations.Persistence.Migrations
{
    ...
    [Migration("20260521121917_AddOrganizations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hemma.Modules.Organizations.Domain.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Organizations.Domain.OrganizationInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Organizations.Domain.OrganizationMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Hemma.Modules.Organizations.Domain.OrganizationMembership", b =>
                {
                    b.HasOne("Hemma.Modules.Organizations.Domain.Organization", null)
