# AGENTS.md - Organizations Module
...
For general module conventions, see [`../../AGENTS.md`](../../AGENTS.md). For the architectural decision, see [`../../../../docs/adr/0035-organizations-and-scoped-authorization.md`](../../../../docs/adr/0035-organizations-and-scoped-authorization.md).
...
Organization permissions live in `Hemma.Modules.Organizations.Contracts/Authorization/OrganizationsPermissions.cs`:
...
Other modules may reference only `Hemma.Modules.Organizations.Contracts`. They must not reference this internal project, query Organizations tables, join across schemas, or add cross-schema foreign keys.

---

## Integration events and cross-module contracts

Public contracts live under `Hemma.Modules.Organizations.Contracts`.
